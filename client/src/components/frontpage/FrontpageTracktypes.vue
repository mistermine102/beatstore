...
<template>
  <section class="py-20 w-full">
    <div class="max-w-[1300px] mx-auto px-6 md:px-8">
      <!-- Section Header -->
      <SectionHeading title="SELECT YOUR VIBE" subtitle="Find the sound that matches your energy." />
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        >
          ...
          <!-- Gradient Overlay -->
          <div
            class="absolute inset-0 bg-gradient-to-t from-black via-black/40 to-transparent opacity-90 transition-opacity duration-300 group-hover:opacity-80"
          ></div>
